...
exports.makeImportPathRelative = exports.protocGenValidate = void 0;
const protobuf_1 = require("@bufbuild/protobuf");
const protoplugin_1 = require("@bufbuild/protoplugin");
const ecmascript_1 = require("@bufbuild/protoplugin/ecmascript");
const validate_pb_1 = require("./proto/validate_pb");
exports.protocGenValidate = (0, protoplugin_1.createEcmaScriptPlugin)({
...
function generateTs(schema) {
    for (const file of schema.files) {
        ...
        f.print(f.exportDecl("type", `ValidationErrorIssue = { \n\tfield: string,\n\tmessage: string\n}\n`));
        f.print(f.exportDecl("class", `ValidationError extends Error {\n\tissues: ValidationErrorIssue[]\n`));
        ...
        for (const message of file.messages) {
            ...
            f.print(f.exportDecl("  interface ", (0, ecmascript_1.localName)(message)), " {");
            ...
            const schemaName = `${(0, ecmascript_1.localName)(message)}Schema`;
            let validateTemplate = `  const ${schemaName} = z.object({\n`;
            for (const field of message.fields) {
                if (field.proto.options && (0, protobuf_1.hasExtension)(field.proto.options, validate_pb_1.rules)) {
                    const rule = (0, protobuf_1.getExtension)(field.proto.options, validate_pb_1.rules);
                    validateTemplate += `      ${field.proto.name}: z${getValidateTemplate(rule)},\n`;
                }
            }
            validateTemplate += `  })\n`;
            ...
            f.print("      const issues: ValidationErrorIssue[] = error.issues.map((issue) => ({");
...
function getValidateTemplate(rule) {
    let t = "";
...
function getValidateStringTemplate(rule) {
...
function getInt32ValidateTemplate(rule) {
    if (rule.type.case != "int32" &&
...
function getInt64ValidateTemplate(rule) {
    if (rule.type.case != "int64" &&
...
function getFloatValidateTemplate(rule) {
...
function getDoubleValidateTemplate(rule) {
...
function getUInt32ValidateTemplate(rule) {
...
function getUInt64ValidateTemplate(rule) {
...
function getBoolValidateTemplate(rule) {
...
function getRepeatedValidateTemplate(rule) {
...
function getValidateAnyTemplate(rule) {
...
function getValidateBytesTemplate(rule) {
...
function getValidateDurationTemplate(rule) {
...
function getValidateTimestampTemplate(rule) {
